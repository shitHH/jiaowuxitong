        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="form1" action="/edu/updatestudent.action" method="post"
                                    ...
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sName" id="sName" class="form-control"
                                                   value="${student.sName}" onchange="sname()">
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="collname" name="collname" class="form-control"
                                                   value="${student.collname}" readonly="readonly">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="mName" name="mName" class="form-control"
                                                   value="${student.mName}" readonly="readonly">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="className" name="className" class="form-control"
                                                   value="${student.className}" readonly="readonly">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="sEmail" name="sEmail" class="form-control"
                                                   value="${student.sEmail}" onchange="semail()">
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="address" name="address" class="form-control"
                                                   value="${student.address}" onchange="add()">
