        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">选课列表</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.jsp">选课管理</a></li>
                            <li class="breadcrumb-item active">选课列表</li>
                        </ul>
                    </div>
                                            ...
                                            <td class="text-right">
                                                <div class="actions">
                                                    <button type="button" class="btn btn-primary"><a
                                                            onclick="myfun(${lession.lId},${currentUser.sId})">选课</a>
                                                    </button>
                                                </div>
                                            </td>
                                        </tr>
...
<script>
    function myfun(lid, sid) {
        $.post("/edu/checksize", {"sid": sid, "lid": lid}, function (data) {
            console.log(data)
            if (data == 1) {
                window.location.href = "${bp}/chooselession.action?lid=" + lid + "&sid=" + sid;
            } else if (data == 2) {
                alert("只能选两门课");
            } else {
                alert("不能选相同课程！")
