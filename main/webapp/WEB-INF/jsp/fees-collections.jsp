							...
							<div class="card card-table">
								<div class="card-body">
									<div class="table-responsive">
										<form action="/edu//tofeescollections.action" method="post">
										<table class="table table-hover table-center mb-0 datatable">
											...
											<tbody>
											<c:forEach var="jiaofei" items="${list}">
												<tr>

													<td>${jiaofei.sId}</td>
													<td>
														<h2 class="table-avatar">
															<a class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="${bp}/img/${currentUser.sPhoto}" alt="User Image"></a>
															<a>${jiaofei.sName}</a>
														</h2>
													</td>
													<td>${jiaofei.collname}</td>
													<td>${jiaofei.mName}</td>
													<td>${jiaofei.className}</td>
													<td>${jiaofei.mMoney}</td>
													<td class="text-right">
