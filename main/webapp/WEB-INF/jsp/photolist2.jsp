        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">课件管理</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.jsp">课件列表</a></li>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-center mb-0 datatable">
                                    ...
                                    <c:forEach items="${list1}" var="list">
                                        <tr>
                                            <td><a href="${bp}/${list.photosrc}">${list.photoname}</a></td>
                                            <td>${list.phototype}</td>
                                            <td>${list.ptname}</td>
                                            <td>${list.ptime}</td>
                                            <td>${list.pip}</td>
                                            <td class="text-right">
                                                <div class="actions">
                                                    <a href="${bp}/pptinfo.action?photoid=${list.photoid}" class="btn btn-sm bg-success-light mr-2">
