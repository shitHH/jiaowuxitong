                                        ...
                                        <tr>
                                            ...
                                            <c:choose>
                                                <c:when test="${lists[loop.count-1]==1}">
                                                    <td>
                                                        <form action="/edu/luruscore" method="post" id="form1">
                                                            <input type="number" name="score"  id="score" style="width: 80px">
                                                            ...
                                                            <input type="hidden" name="sId" value="${students.sId}"
                                                                   style="width: 80px">
                                                            <button type="button" class="btn btn-rounded btn-info" onclick="fun3()"
                                                            >
                                                                录入成绩
                                                            </button>
                                                        </form>
